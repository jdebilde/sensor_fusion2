...
class Position_stevin2(ViewBase):
    name = "position_stevin2"
    ...
    def redraw(self):
        ...
        # self.ax_pos.scatter(px_cm, py_cm, s=5, label="trajectory")
    ...
    def draw_real_trajectory(self, index=0):
        ...
        if index == 0:
            ...
            # x_m, y_m, width_m, height_m = 2 * 0.8 + 0.115, 1 * 1.6 + 0.15, 0.575, 1.40
            x_m, y_m, width_m, height_m = 2 * 0.8 + 0.115, 1 * 1.6 + 0.15, 0.575, 3.0
            x_cm = x_m * 100.0
            y_cm = y_m * 100.0
            width_cm = width_m * 100.0
            height_cm = height_m * 100.0
            ...
            x_m, y_m = 2 * 0.8 + 0.4, 1 * 1.6 + 0.8 - 0.25
            x_cm = x_m * 100.0
            y_cm = y_m * 100.0
